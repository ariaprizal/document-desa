...
<body>
    <div class="detail-submissions">
        ...
        <div class="validation" style="padding-left: 5rem;">
            <a href="{{route('validation-rw', ['id' =>$submit->id, 'level'=>'desa'])}}" class="btn btn-outline-success">Setujui</a>
            <a href="{{route('validation-rw', ['id' =>$submit->id, 'level'=>'0'])}}" type="button" class="btn btn-outline-danger">Tolak</a>
        </div>
        @endforeach
        @endforeach
    </div>
